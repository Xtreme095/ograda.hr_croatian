...
$template_bots           = total_rows(db_prefix() . 'whatsapp_campaigns', ['is_bot' => 1]);
...
$total_template_bot_send = sum_from_table(db_prefix() . 'whatsapp_campaigns', ['field' => 'sending_count', 'where' => ['is_bot' => 1]]);
$total_bot_send = $total_message_bot_send + $total_template_bot_send;

?>
<div class="widget relative mtop10 mbot10" id="widget-<?php echo basename(__FILE__, '.php'); ?>" data-name="<?php echo _l('whatsapp_stats'); ?>">
