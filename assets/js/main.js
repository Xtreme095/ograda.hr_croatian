...
function clear_item_preview_values(default_taxes) {
  ...
  previewArea.find('input[name="height"]').val("");
  previewArea.find('input[name="length"]').val("");
  previewArea.find('input[name="spacing"]').val("");
  previewArea.find('input[name="unit"]').val("");
...
function add_item_to_table(data, itemid, merge_invoice, bill_expense) {
  ...
  get_taxes_dropdown_template(tax_name, data.taxname).done(function (
    ...
    table_row +=
      ...
      data.description +
      '</textarea><input type="number" name="newitems[' +
      item_key +
      '][height]" class="form-control" placeholder="Visina" aria-invalid="false" style="min-width: 150px" value="'+data.height+'"></td>';
    ...
    table_row +=
      ...
      '</textarea><input type="number" name="newitems[' +
      item_key +
      '][length]" class="form-control" placeholder="Širina" aria-invalid="false" style="min-width: 150px" value="'+data.length+'"></td>';
    ...
    table_row +=
      ...
      data.unit +
      '"><br><input type="number" name="newitems[' +
      item_key +
      '][spacing]" class="form-control" placeholder="Razmak" aria-invalid="false" style="min-width: 150px" value="'+data.spacing+'">';
...
function get_item_preview_values() {
  ...
  response.height = $('.main input[name="height"]').val();
  response.length = $('.main input[name="length"]').val();
  ...
  $('.main input[name="height"]').val('');
  $('.main input[name="length"]').val('');
