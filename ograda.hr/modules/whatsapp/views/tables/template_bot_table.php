...
$aColumns = [
    'name',
    'bot_type',
    db_prefix().'whatsapp_campaigns.trigger as trigger_message',
    'rel_type',
    'is_bot_active',
];
...
foreach ($rResult as $aRow) {
    ...
    $row[] = _l('template_bot').' : '.str_replace('Reply bot: ', '', whatsapp_get_reply_type($aRow['bot_type'])['label']);
    ...
    if (staff_can('edit', 'whatsapp_template_bot')) {
        $options .= '<a href="'.admin_url('whatsapp/bots/bot/template/'.$aRow['id']).'" data-toggle="tooltip" data-title="'._l('edit').'" class="tw-text-neutral-500 hover:tw-text-neutral-700 focus:tw-text-neutral-700"><i class="fa-regular fa-pen-to-square fa-lg"></i></a>';
    }
