...
*
*/
define('APP_BASE_URL', 'https://ograda.hr/');
...
*/
define('APP_ENC_KEY', 'c4f2f300ba8bcdec4923f642f6fe41ff');
 ...
 */
define('APP_DB_USERNAME', 'adfnrcxmjd');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'RmhSFDhg42');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'adfnrcxmjd');
