...
// Redirect old product URLs to the products page
$route['ograda/(:any)'] = 'home/products';

$route['product-details'] = 'home/product';
$route['contact'] = 'home/contact';
$route['terms-of-use'] = 'home/terms_of_use';
$route['privacy-policy'] = 'home/privacy_policy';
$route['proposal'] = 'home/proposal';

$route['subscribe-newsletter'] = 'Newsletter/subscribe';
$route['contact/save'] = 'contact/save';

// Facebook product feed route
$route['facebook-product-feed'] = 'products/FacebookFeed';
$route['facebook-product-feed/generate'] = 'products/FacebookFeed/generate_static_feed';

// Add direct access to the XML file
$route['product-feed.xml'] = 'products/FacebookFeed';
