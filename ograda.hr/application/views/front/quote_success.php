        ...
        <div class="col-md-8">
            <div class="card mt-5 mb-5">
                <div class="card-body text-center p-5">
                    ...
                    <p class="lead mb-4">
                        Zaprimili smo Vaš upit i kontaktirat ćemo Vas u najkraćem mogućem roku.
                        Za sva dodatna pitanja slobodno nas nazovite na +385 912001500.
                    </p>
                    
                    <?php if(isset($invoice_id) && isset($hash)): ?>
